...
const COUNSELLORS = ['Jasmeet Kaur', 'Komal Pandey', 'Prerna Kaushik', 'Harsha Vardhini Pirupilli', 'Drishti Majumdar', 'Ishan Ali', 'Sunny Singh', 'Aniket Singh', 'Devam Chandna', 'Aprajita', 'Simran Mishra']
...
function extractBlackoutLeads(rows, campaign, source, type) {
  ...
  // Lead Dump (A:CK): H=7 campaign, G=6 source, A=0 name, B=1 email, C=2 mobile, BC=54 counsellor, BD=55 stage, BA=52 registered
  // App Start Dump (A:EY): W=22 campaign, S=18 source, M=12 name, N=13 email, O=14 mobile, AR=43 counsellor, AU=46 stage, Q=16 registered
